    ...
    public void run() {
        ...
        synchronized (gameData.lock1) {
            ...
            while (gameData.playerSuccessFlag[0] == false && gameData.playerSuccessFlag[1] == false) {
                ...
                /*
                 * STEP-3: write code to take a lock on gameData using lock2 and wait while no
                 * number has been pressed by the user on the GUI (See actionPerformed method of
                 * the GameGUI class HINT: until the number is not announced the variable
                 * numberAnnounced remains 0 (zero)
                 */
            ...
            /*
             * UNCOMMENT THE FOLLOWING TWO LINES OF CODE ONCE YOU FINISH WRITTING CODE FOR
             * ALL STEPS ABOVE
             */
